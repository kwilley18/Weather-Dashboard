  /*  const apiKey = "dd7a4274028a914e127cd1f231e7c5a0";
    const inputValue = input.value; 
    var citiesArray = JSON.parse(localStorage.getItem("cities")) || [];
    var queryUrl = `https://api.openweathermap.org/data/2.5/weather?q=${inputValue}&appid=${apiKey}&units=metric`;
    var m = moment(); */ 
...
var citiesArray = JSON.parse(localStorage.getItem("cities")) || [];
    ...
    //var cities = citiesArray[citiesArray.length-1]; 
var m = moment(); 
...
function citySearch(city){
    ...
    $.ajax({
        ...
        var todaysDate = moment.unix(dateInfo).format("L");
...
function fiveDayForecast(city) {
	...
	$.ajax({
		...
		$(".dayThreeTemp").append("Temperature: ");
		$(".dayThreeTemp").append(
			tempAvg(
		...
		$(".dayThreeTemp").append(" °F");

		$(".dayFourTemp").append("Temperature: ");
		$(".dayFourTemp").append(
			tempAvg(
		...
		$(".dayFourTemp").append(" °F");

		$(".dayFiveTemp").append("Temperature: ");
		$(".dayFiveTemp").append(
			tempAvg(
		...
		$(".dayThreeHumid").append("Humidity: ");
		$(".dayThreeHumid").append(
			humidityAvg(
